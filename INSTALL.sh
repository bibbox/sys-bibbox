...
cp /opt/bibbox/sys-bibbox/config-templates/000-default.conf /opt/bibbox/proxy/sites/000-default-le-ssl.conf.conf
...
docker exec -it bibbox-sys-commander-apacheproxy graceful -k graceful
