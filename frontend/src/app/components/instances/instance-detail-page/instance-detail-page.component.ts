...
import { InstanceTileComponent } from '../instance-tile/instance-tile.component';
...
export class InstanceDetailPageComponent implements OnInit {
  ...
  constructor(
    ...
    private instanceTile: InstanceTileComponent,
  ) {
  ...
  ngOnInit(): void {
    ...
    this.primaryUrl = this.instanceTile.instanceUrl;
